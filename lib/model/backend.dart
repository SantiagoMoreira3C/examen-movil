...
class Backend {
  ...
  final _celulars=[
     Celular(id: 1, name: 'Galaxy A32', model: 'Samsung', precio:'300' , description: 'Gama alta'),
      Celular(id: 2, name: 'Huawei Mate 40', model: 'Huawei', precio: '450' , description: 'Gama alta'),
      Celular(id: 3, name: '12 Pro Max', model: 'Apple', precio: '1300' , description: 'Gama alta'),
      Celular(id: 4, name: 'Xiaomi Mi 11', model: 'Xiaomi', precio: '350' , description: 'Gama media'),
       Celular(id: 5, name: 'LG K61', model: 'LG', precio: '370', description: 'Gama alta'),
       Celular(id: 5, name: 'Motorola Moto Z3', model: 'Motorola', precio: '275' , description: 'Gama Baja'),
  ];
